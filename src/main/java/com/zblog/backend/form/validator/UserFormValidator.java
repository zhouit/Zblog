...
public class UserFormValidator{
  ...
  public static MapContainer validateInsert(User user, String repass){
    ...
    }else if(StringUtils.isBlank(user.getPassword()) || StringUtils.isBlank(repass)){
      form.put("password", "需填写用户密码");
    }else if(!user.getPassword().equals(repass) || !user.getPassword().matches(CommRegular.PASSWD)){
